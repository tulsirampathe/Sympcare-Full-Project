...
const Services = () => {
  ...
  return (
    <section
      className="relative px-6 py-20 bg-gradient-to-b from-white via-blue-50 to-white"
      id="services"
    >
      {/* Hero Header */}
      <motion.div
      ...
      >
        <div className="inline-flex items-center mb-4 space-x-3">
          ...
          <h3 className="text-lg font-semibold text-blue-500">Our Services</h3>
          <div className="w-12 h-1 bg-blue-500 rounded-full"></div>
        </div>
      ...
      >
        ...
        >
          ...
          {/* Hackathon Badge */}
          <div className="absolute top-5 right-5 bg-gradient-to-r from-blue-800 to-blue-900 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg z-10">
            <FaStar className="text-yellow-300 animate-pulse" />
            <FaStar className="text-yellow-300 animate-pulse" />
            <FaStar className="text-yellow-300 animate-pulse" />
          </div>

          <div className="relative z-10 p-10 lg:p-14 flex flex-col lg:flex-row items-center gap-10">
            {/* Left Content */}
            <div className="flex-1 text-white space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-3xl font-bold">Medical Report Analysis</h3>
              </div>
              ...
              <motion.button
                className="bg-white text-blue-600 px-8 py-3 rounded-xl font-bold text-base flex items-center gap-2 hover:gap-3 transition-all duration-300 hover:shadow-xl group-hover:scale-105"
            ...
            >
              <div className="bg-white/10 p-5 rounded-2xl backdrop-blur-sm border border-white/20 max-w-xs">
      ...
      >
        {services.map((service, index) => (
          <motion.div
            ...
            className="group relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer border border-blue-100 hover:border-blue-300 hover:-translate-y-2"
            whileHover={{ scale: 1.02 }}
          >
            <div
              className={`${service.color} w-14 h-14 rounded-xl mb-6 flex items-center justify-center transform group-hover:rotate-12 transition-all duration-300 shadow-md`}
            >
              {service.icon}
            </div>
            ...
            <p className="text-gray-600 text-base mb-6">{service.text}</p>
            <div className="flex items-center text-blue-500 font-semibold group-hover:translate-x-2 transition-transform duration-300">
